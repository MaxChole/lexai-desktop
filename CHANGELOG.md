...
### Changed
- 继续优化本地模式“联网增强”答案质量：官方/参考来源的排序权重更严格，检索上下文改为更像法律证据卡片的结构；同时收紧本地模型回答模板，减少复述用户问题的机械感，并要求按“结论 + 规则要点 + 句末引用”的形式输出
- 本地模式新增“联网增强”第二版：在免费公开资料检索基础上，继续补充法律来源优先过滤、官方来源标记，以及正文内联 `[来源1]` 引用提示；回答底部的参考来源列表也同步改成更清楚的证据卡片格式
